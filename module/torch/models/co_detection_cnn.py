...
class CoDetectionCNN(nn.Module):
    def __init__(self, n_channels, n_classes, up_method, up_mode):
        super().__init__()
        factor = 2 if up_method == 'upsample' else 1
        ...
        self.up1 = Up(1024, 512 // factor, up_method=up_method, up_mode=up_mode)
        self.up2 = Up(512, 256 // factor, up_method=up_method, up_mode=up_mode)
        self.up3_t1 = Up(256, 128 // factor, up_method=up_method, up_mode=up_mode)
        self.up3_t2 = Up(256, 128 // factor, up_method=up_method, up_mode=up_mode)
        self.up4_t1 = Up(128, 64 // factor, up_method=up_method, up_mode=up_mode)
        self.up4_t2 = Up(128, 64 // factor, up_method=up_method, up_mode=up_mode)

        self.out_t1 = OutConv(64 // factor, n_classes)
        self.out_t2 = OutConv(64 // factor, n_classes)
...
class CoDetectionCNNJ1(nn.Module):
    def __init__(self, n_channels, n_classes, up_method, up_mode):
        ...
        self.up1 = Up(1024, 512, up_method=up_method, up_mode=up_mode)
        self.up2 = Up(512, 256, up_method=up_method, up_mode=up_mode)
        self.up3 = Up(256, 128, up_method=up_method, up_mode=up_mode)
        self.up4_t1 = Up(128, 64, up_method=up_method, up_mode=up_mode)
        self.up4_t2 = Up(128, 64, up_method=up_method, up_mode=up_mode)
...
class CoDetectionBase(nn.Module):
    def __init__(self, input_ch, up_method, up_mode):
        super(CoDetectionBase, self).__init__()
        factor = 2 if up_method == 'upsample' else 1
        self.inc = InConv(input_ch, 64)
...
class CoDetectionClassifier(nn.Module):
    def __init__(self, n_class, up_method, up_mode):
        super(CoDetectionClassifier, self).__init__()
        factor = 2 if up_method == 'upsample' else 1
        self.up3 = Up(256, 128 // factor, up_method=up_method, up_mode=up_mode)
        self.up4 = Up(128, 64 // factor, up_method=up_method, up_mode=up_mode)
        self.out = OutConv(64 // factor, n_class)
