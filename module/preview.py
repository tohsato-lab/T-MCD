...
class Preview:
    def __init__(self, log_path=None, palette: list = None):
    ...
    def show(self, images_array, title: str = None, type_name=None, mode=None, output_filename=None):
        ...
        for images_index, images in enumerate(images_array):
            ...
            if self.log_root is not None and output_filename is not None:
                output_path = Path(self.log_root).joinpath(output_filename)
                os.makedirs(output_path.parent, exist_ok=True)
                if output_path.exists():
                    output_path = output_path.parent.joinpath(self.add_date(output_path.name))
                plt.imsave(output_path, integrated_image)
            else:
